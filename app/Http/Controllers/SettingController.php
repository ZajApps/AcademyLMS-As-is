    ...
    public function update_home(Request $request, $id)
    {
        ...
        if ($home_page == 'cooking') {
            ...
            if ($request->hasFile('image')) {
                ...
                $image->move(public_path('uploads/home_page_image/cooking/'), $image_name);
            ...
            if ($request->hasFile('image')) {
                ...
                $request->file('image')->move(public_path('uploads/home_page_image/university/'), $image_name);
                $previous_image = $request->input('previous_image');
                $speech['image'] = $image_name;
                if (!empty($previous_image)) {
            ...
            if ($request->hasFile('faq_image')) {
                ...
                $request->file('faq_image')->move(public_path('uploads/home_page_image/university/'), $image_names);
            ...
            if ($request->hasFile('image')) {
                ...
                $image->move(public_path('uploads/home_page_image/development/'), $image_name);
                $speech['image'] = $image_name;
            ...
            if ($request->hasFile('image')) {
                $image = $request->file('image');
                $image_name = uniqid() . '.' . $image->getClientOriginalName();
                $image->move(public_path('uploads/home_page_image/kindergarden/'), $image_name);
                $speech['image'] = $image_name;
            ...
            if ($request->hasFile('image')) {
                $image = $request->file('image');
                $image_name = uniqid() . '.' . $image->getClientOriginalName();
                $image->move(public_path('uploads/home_page_image/marketplace/'), $image_name);
            ...
            if ($request->hasFile('big_image')) {
                ...
                $request->file('big_image')->move(public_path('uploads/home_page_image/meditation/'), $image_name);
            ...
            foreach ($meditations as $meditation) {
                ...
                if ($request->hasFile($meditation_image_field)) {
                    ...
                    $image_name = uniqid() . '.' . $image->getClientOriginalName();
                    $image->move(public_path('uploads/home_page_image/meditation/'), $image_name);
