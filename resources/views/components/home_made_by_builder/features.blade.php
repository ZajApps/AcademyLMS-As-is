            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6  ps-border">
                    <div class="ps-single-wrap">
                        <img class="builder-editable" builder-identity="1" src="{{asset("http://localhost/academy-laravel/academy-laravel/public/assets/page-builder/block-image/p1.png")}}" alt="...">
