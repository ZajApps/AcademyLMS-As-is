        ...
        <div class="row justify-content-center">
            <div class="col-md-6 order-2 order-md-1">
                <div class="banner-content">
                    <h5 class="d-flex"><img class="builder-editable" builder-identity="1" src="{{asset("http://localhost/academy-laravel/academy-laravel/public/assets/page-builder/block-image/roket.svg")}}" alt="..."> <span class="builder-editable" builder-identity="2">The Leader in online learning</span></h5>
                    <h1>
