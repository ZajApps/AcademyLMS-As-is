...
<section class="testimonials-wrapper section-padding">
    <span class="elips left-elips"><img class="builder-editable" builder-identity="1" src="{{asset("http://localhost/academy-laravel/academy-laravel/public/assets/page-builder/block-image/Ellipse 8.png")}}" alt="..."></span>
    <span class="elips right-elips"><img class="builder-editable" builder-identity="2" src="{{asset("http://localhost/academy-laravel/academy-laravel/public/assets/page-builder/block-image/Ellipse 9.png")}}" alt="..."></span>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="user-slider owl-carousel owl-theme">
                    ...
                    <div class="single-opinion">
                        ...
                        <div class="testimonial-border">
                            <div class="testimonial-des">
                                <p class="description"><span class="builder-editable" builder-identity="11" >It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.</span></p>
                                <div class="user-info d-flex">
                                    <div>
                    ...
                    <div class="single-opinion">
                        ...
                        <div class="testimonial-border">
                            <div class="testimonial-des">
                                <span class="description"><span class="builder-editable" builder-identity="15" >It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.</span></p>
                                    <div class="user-info d-flex">
                                        <div>
                    ...
                    <div class="single-opinion">
                        ...
                        <div class="testimonial-border">
                            <div class="testimonial-des">
                                <p class="description"><span class="builder-editable" builder-identity="19" >It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.</span></p>
                                <div class="user-info d-flex">
                                    <div>
                    ...
                    <div class="single-opinion">
                        ...
                        <div class="testimonial-border">
                            <div class="testimonial-des">
                                <p class="description"><span class="builder-editable" builder-identity="23" >It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of use Lorem Ipsum.</span></p>
                                <div class="user-info d-flex">
                                    <div>
